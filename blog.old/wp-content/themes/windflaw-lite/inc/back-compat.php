...
function windflaw_upgrade_notice() {
	$message = sprintf(__('Windflaw requires at least WordPress version 4.3. You are running version %s. Please upgrade and try again.', 'windflaw-lite'), $GLOBALS['wp_version']);
...
function windflaw_customize() {
	wp_die( sprintf( __( 'Windflaw requires at least WordPress version 4.3. You are running version %s. Please upgrade and try again.', 'windflaw-lite'), $GLOBALS['wp_version']), '', array(
		'back_link' => true,
	));
}
...
function windflaw_preview(){
	if(isset($_GET['preview'])){
		wp_die(sprintf(__('Windflaw requires at least WordPress version 4.3. You are running version %s. Please upgrade and try again.', 'windflaw-lite'), $GLOBALS['wp_version']));
	}
}
