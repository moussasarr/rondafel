...
define('WINDFLAW_THEME_VERSION', '1.0.6');
...
if(!function_exists('windflaw_wp_core_support')){
	...
	function windflaw_wp_core_support(){
		...
		load_theme_textdomain('windflaw-lite', WINDFLAW_THEME_ROOT . '/languages');

		$GLOBALS['content_width'] = apply_filters('windflaw_content_width', 840);
		...
		register_nav_menus(array('primary' => __('Primary Menu', 'windflaw-lite')));
	...
	function windflaw_wp_sidebars(){
		...
		register_sidebar(array(
			'name'          => __('Footer Widget Area ', 'windflaw-lite'),
			'id'            => 'sidebar-1',
			'description'   => __('Add widgets here to appear in your footer main sidebar.', 'windflaw-lite'),
