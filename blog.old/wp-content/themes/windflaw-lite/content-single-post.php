	...
	<?php
		the_post_navigation( array(
			'next_text' => '<span class="meta-nav" aria-hidden="true">' . __('Next', 'windflaw-lite') . '</span> ' .
				'<span class="screen-reader-text">' . __('Next post:', 'windflaw-lite') . '</span> ' .
				'<span class="post-title">%title</span>',
			'prev_text' => '<span class="meta-nav" aria-hidden="true">' . __('Previous', 'windflaw-lite') . '</span> ' .
				'<span class="screen-reader-text">' . __('Previous post:', 'windflaw-lite') . '</span> ' .
				'<span class="post-title">%title</span>',
		));
	?>
